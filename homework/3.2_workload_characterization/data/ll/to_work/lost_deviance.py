...
PCA_COLS = ["Principale1", "Principale2", "Principale3", "Principale4", "Principale5", "Principale6", "Principale7", "Principale8"]
UNUSED_COLS = ["Cluster"]
...
if __name__ == "__main__":
    ...
    # the script will fallback to processing a single `ll_pca_clustering.csv` in the same dir.
    csv_folder = os.path.join(script_dir, "csv")
    fallback_csv = os.path.join(script_dir, "ll_pca_clustering.csv")
